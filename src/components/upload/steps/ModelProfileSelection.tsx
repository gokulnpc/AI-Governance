...
import { Shield, CreditCard, LineChart, Briefcase, AlertTriangle } from 'lucide-react';
          ...
          <div className="p-4 bg-yellow-50 rounded-lg flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700">
                The selected profile will determine the specific bias testing scenarios and regulatory compliance checks applied to your model.
              </p>
            </div>
          </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {profile.regulatoryFrameworks.map((framework, idx) => (
